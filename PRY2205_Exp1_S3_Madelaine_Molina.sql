...
SELECT
    ...
    TO_CHAR(NVL(ROUND(AVG(e.sueldo_emp)), 0),'$999G999G999') AS "SUELDO PROMEDIO",
...
SELECT
    ...
    TO_CHAR(ROUND(AVG(p.valor_arriendo)),'$999G999G999')   AS "PROM ARRIENDO",
